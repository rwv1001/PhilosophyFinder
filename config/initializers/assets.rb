...
Rails.application.config.assets.precompile += %w( apple-touch-icon-57x57.png  )
Rails.application.config.assets.precompile += %w( apple-touch-icon-57x57-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-60x60.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-60x60-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-72x72.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-72x72-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-76x76.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-76x76-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-114x114.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-114x114-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-120x120.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-120x120-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-144x144.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-144x144-precomposed.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-152x152.png )
Rails.application.config.assets.precompile += %w( apple-touch-icon-152x152-precomposed.png )
