...
DOMAIN_ACTION = {:select_action => "select_action", :search_domain => "search_domain",:new_domain => "new_domain", :fix_domain => "fix_domain", :set_paragraphs => "set_paragraphs" ,:rename => "rename",:move_domain => "move_domain",:remove_domain => "remove_domain"}
MAX_DISPLAY = 50
MAX_RESULTS = 1000
MAX_QUERY_STORE = 10
